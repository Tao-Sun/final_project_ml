    ...
    with tf.Graph().as_default(), tf.Session() as session:
        ...
        for step in xrange(FLAGS.max_steps):
            ...
            if step % 1000 == 0:
                ...
                print encoded_inputs[2]
                print encoded_inputs[3]
                print encoded_inputs[4]
...
def inference(_):
    ...
    with tf.Graph().as_default(), tf.Session() as session:
        ...
        examples_file = FLAGS.output_dir + '/examples.txt'
        while datasets.train.epochs_completed == 0:
            ...
            with open(examples_file, 'a') as output:
